...
import './Home.css'
import faceImg from '../../assets/image.svg'
        ...
        <div className="home-hero-inner">
          <div className="home-hero-left">
            ...
            <h1 className="home-hero-title">
              Discover Your <span className="home-hero-highlight">Best Version.</span>
            </h1>
          ...
          <div className="home-hero-right">
            ...
            <div className="home-float-card score">
            ...
            <div className="home-float-card balance">
              <div className="home-float-icon">
            ...
            <div className="home-float-card model">
              <div className="home-float-icon">
